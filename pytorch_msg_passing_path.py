...
def get_running_dag_mat(job_dags):
    ...
    # running_dag_indices = np.asmatrix([running_dag_row_idx, running_dag_col_idx]).transpose()
    running_dag_indices = np.asmatrix([running_dag_row_idx, running_dag_col_idx])
...
def get_unfinished_nodes_summ_mat(job_dags):
    ...
    summ_indices = np.asmatrix([summ_row_idx, summ_col_idx])
